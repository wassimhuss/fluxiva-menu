...
export function OnboardingPage() {
  ...
  const [form, setForm] = useState({ name_en: '', name_ar: '', slug: '', primary_color: '#b84d2f', whatsapp: '', address_en: '', address_ar: '', default_language: 'en' as 'en' | 'ar' })
