...
- Restaurant logo, cover, theme, contact details, opening state, and default language.
  - A restaurant-wide food-photo visibility switch. Hiding photos preserves the uploaded files, limits the design picker to the image-free Classic, Noir, and Bistro templates, and safely falls back to Classic when a photo-based design had been selected.
